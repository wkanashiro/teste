...
-- Started on 2014-11-05 17:35:40
...
--
-- TOC entry 2220 (class 1262 OID 12002)
-- Dependencies: 2219
...
-- Name: siscad; Type: SCHEMA; Schema: -; Owner: postgres
--

CREATE SCHEMA siscad;


ALTER SCHEMA siscad OWNER TO postgres;
...
-- Name: version; Type: SCHEMA; Schema: -; Owner: postgres
--

CREATE SCHEMA version;


ALTER SCHEMA version OWNER TO postgres;

--
-- TOC entry 209 (class 3079 OID 11727)
...
--
-- TOC entry 208 (class 3079 OID 16384)
...
--
-- TOC entry 222 (class 1255 OID 16396)
-- Name: _no_accents(text); Type: FUNCTION; Schema: titan; Owner: postgres
--
...
ALTER FUNCTION titan._no_accents(text) OWNER TO postgres;

SET search_path = siscad, pg_catalog;
...
--
-- TOC entry 193 (class 1259 OID 24608)
-- Name: aluno; Type: TABLE; Schema: siscad; Owner: postgres; Tablespace: 
--

CREATE TABLE aluno (
    id integer DEFAULT nextval(('siscad.aluno_id_seq'::text)::regclass) NOT NULL,
...
ALTER TABLE siscad.aluno OWNER TO postgres;

--
-- TOC entry 194 (class 1259 OID 24630)
-- Name: aluno_id_seq; Type: SEQUENCE; Schema: siscad; Owner: postgres
--
...
ALTER TABLE siscad.aluno_id_seq OWNER TO postgres;

--
-- TOC entry 2225 (class 0 OID 0)
-- Dependencies: 194
-- Name: aluno_id_seq; Type: SEQUENCE SET; Schema: siscad; Owner: postgres
--

SELECT pg_catalog.setval('aluno_id_seq', 6, true);


--
-- TOC entry 199 (class 1259 OID 24692)
-- Name: curso; Type: TABLE; Schema: siscad; Owner: postgres; Tablespace: 
--

CREATE TABLE curso (
    id integer NOT NULL,
    nome character varying(100) NOT NULL,
    sigla character varying(18) NOT NULL,
    descricao character varying(256),
    coordenador character varying(100) NOT NULL,
    duracao_min integer NOT NULL,
    duracao_max integer NOT NULL,
    carga_horaria_obrigatoria integer NOT NULL,
    carga_horaria_optativa integer NOT NULL,
    data_criacao_curso timestamp without time zone NOT NULL,
    _user integer NOT NULL,
    _create timestamp with time zone DEFAULT now() NOT NULL,
    _update timestamp with time zone DEFAULT now() NOT NULL,
    email_coordenador character varying(100)
);


ALTER TABLE siscad.curso OWNER TO postgres;

--
-- TOC entry 198 (class 1259 OID 24690)
-- Name: curso_id_seq; Type: SEQUENCE; Schema: siscad; Owner: postgres
--
...
ALTER TABLE siscad.curso_id_seq OWNER TO postgres;

--
-- TOC entry 2226 (class 0 OID 0)
-- Dependencies: 198
-- Name: curso_id_seq; Type: SEQUENCE OWNED BY; Schema: siscad; Owner: postgres
--
...
-- Dependencies: 198
-- Name: curso_id_seq; Type: SEQUENCE SET; Schema: siscad; Owner: postgres
--
...
-- Name: disciplina; Type: TABLE; Schema: siscad; Owner: postgres; Tablespace: 
--
...
CREATE TABLE disciplina (
    ...
    cargahoraria character varying(18),
    tipo character varying(18),
    _user integer NOT NULL,
    _create timestamp with time zone DEFAULT now() NOT NULL,
    _update timestamp with time zone DEFAULT now() NOT NULL
);
...
ALTER TABLE siscad.disciplina OWNER TO postgres;

--
-- TOC entry 196 (class 1259 OID 24669)
-- Name: disciplina_id_seq; Type: SEQUENCE; Schema: siscad; Owner: postgres
--
...
ALTER TABLE siscad.disciplina_id_seq OWNER TO postgres;

--
-- TOC entry 2228 (class 0 OID 0)
-- Dependencies: 196
-- Name: disciplina_id_seq; Type: SEQUENCE OWNED BY; Schema: siscad; Owner: postgres
--
...
-- Dependencies: 196
-- Name: disciplina_id_seq; Type: SEQUENCE SET; Schema: siscad; Owner: postgres
--

SELECT pg_catalog.setval('disciplina_id_seq', 2, true);


--
-- TOC entry 207 (class 1259 OID 24820)
-- Name: faltas; Type: TABLE; Schema: siscad; Owner: postgres; Tablespace: 
--
...
ALTER TABLE siscad.faltas OWNER TO postgres;

--
-- TOC entry 206 (class 1259 OID 24818)
-- Name: faltas_id_seq; Type: SEQUENCE; Schema: siscad; Owner: postgres
--

CREATE SEQUENCE faltas_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE siscad.faltas_id_seq OWNER TO postgres;

--
-- TOC entry 2230 (class 0 OID 0)
-- Dependencies: 206
-- Name: faltas_id_seq; Type: SEQUENCE OWNED BY; Schema: siscad; Owner: postgres
--

ALTER SEQUENCE faltas_id_seq OWNED BY faltas.id;


--
-- TOC entry 2231 (class 0 OID 0)
-- Dependencies: 206
-- Name: faltas_id_seq; Type: SEQUENCE SET; Schema: siscad; Owner: postgres
--

SELECT pg_catalog.setval('faltas_id_seq', 1, false);


--
-- TOC entry 203 (class 1259 OID 24770)
-- Name: matricula; Type: TABLE; Schema: siscad; Owner: postgres; Tablespace: 
--

CREATE TABLE matricula (
    id integer NOT NULL,
    data_matricula timestamp without time zone NOT NULL,
    ano integer NOT NULL,
    semestre character varying(18) NOT NULL,
    id_turma integer NOT NULL,
    id_aluno integer NOT NULL,
    _user integer NOT NULL,
    _create timestamp with time zone DEFAULT now() NOT NULL,
...
ALTER TABLE siscad.matricula OWNER TO postgres;

--
-- TOC entry 202 (class 1259 OID 24768)
-- Name: matricula_id_seq; Type: SEQUENCE; Schema: siscad; Owner: postgres
--
...
ALTER TABLE siscad.matricula_id_seq OWNER TO postgres;

--
-- TOC entry 2232 (class 0 OID 0)
-- Dependencies: 202
-- Name: matricula_id_seq; Type: SEQUENCE OWNED BY; Schema: siscad; Owner: postgres
--
...
-- Dependencies: 202
-- Name: matricula_id_seq; Type: SEQUENCE SET; Schema: siscad; Owner: postgres
--

SELECT pg_catalog.setval('matricula_id_seq', 4, true);


--
-- TOC entry 205 (class 1259 OID 24795)
-- Name: nota; Type: TABLE; Schema: siscad; Owner: postgres; Tablespace: 
--

CREATE TABLE nota (
    id integer NOT NULL,
    valor_real integer NOT NULL,
    valor_equivalente integer NOT NULL,
    id_aluno integer NOT NULL,
    id_turma integer NOT NULL,
    _user integer NOT NULL,
    _create timestamp with time zone DEFAULT now() NOT NULL,
...
ALTER TABLE siscad.nota OWNER TO postgres;

--
-- TOC entry 204 (class 1259 OID 24793)
-- Name: nota_id_seq; Type: SEQUENCE; Schema: siscad; Owner: postgres
--
...
ALTER TABLE siscad.nota_id_seq OWNER TO postgres;

--
-- TOC entry 2234 (class 0 OID 0)
-- Dependencies: 204
-- Name: nota_id_seq; Type: SEQUENCE OWNED BY; Schema: siscad; Owner: postgres
--
...
-- Dependencies: 204
-- Name: nota_id_seq; Type: SEQUENCE SET; Schema: siscad; Owner: postgres
--
...
--
-- TOC entry 192 (class 1259 OID 24584)
-- Name: professor; Type: TABLE; Schema: siscad; Owner: postgres; Tablespace: 
--

CREATE TABLE professor (
    id integer DEFAULT nextval(('siscad.professor_id_seq'::text)::regclass) NOT NULL,
    nome character varying(100) NOT NULL,
    datanascimento timestamp(0) without time zone NOT NULL,
    escolaridade character varying(100) NOT NULL,
    endereco character varying(100) NOT NULL,
    email character varying(50) NOT NULL,
    cpf character varying(18) NOT NULL,
    sexo character varying(18),
...
ALTER TABLE siscad.professor OWNER TO postgres;

--
-- TOC entry 195 (class 1259 OID 24635)
-- Name: professor_id_seq; Type: SEQUENCE; Schema: siscad; Owner: postgres
--
...
ALTER TABLE siscad.professor_id_seq OWNER TO postgres;

--
-- TOC entry 2236 (class 0 OID 0)
-- Dependencies: 195
-- Name: professor_id_seq; Type: SEQUENCE SET; Schema: siscad; Owner: postgres
--
...
-- Name: turma; Type: TABLE; Schema: siscad; Owner: postgres; Tablespace: 
--
...
CREATE TABLE turma (
    ...
    semestre character varying(18) NOT NULL,
    ano integer NOT NULL,
    turno character varying(18) NOT NULL,
    local character varying(50),
    horario_aula character varying(50),
    ...
    _create timestamp with time zone DEFAULT now() NOT NULL,
    _update timestamp with time zone DEFAULT now() NOT NULL,
    quantidade_prova integer DEFAULT 0 NOT NULL,
    quantidade_trabalho integer DEFAULT 0 NOT NULL,
    valor_prova integer DEFAULT 0 NOT NULL,
    valor_trabalho integer DEFAULT 0 NOT NULL,
    ps bit(1) DEFAULT B'0'::"bit" NOT NULL
);


ALTER TABLE siscad.turma OWNER TO postgres;

--
-- TOC entry 200 (class 1259 OID 24733)
-- Name: turma_id_seq; Type: SEQUENCE; Schema: siscad; Owner: postgres
--
...
ALTER TABLE siscad.turma_id_seq OWNER TO postgres;

--
-- TOC entry 2237 (class 0 OID 0)
-- Dependencies: 200
-- Name: turma_id_seq; Type: SEQUENCE OWNED BY; Schema: siscad; Owner: postgres
--
...
-- Dependencies: 200
-- Name: turma_id_seq; Type: SEQUENCE SET; Schema: siscad; Owner: postgres
--

SELECT pg_catalog.setval('turma_id_seq', 3, true);
...
-- Name: _city; Type: TABLE; Schema: titan; Owner: postgres; Tablespace: 
--
...
ALTER TABLE titan._city OWNER TO postgres;

--
-- TOC entry 185 (class 1259 OID 16466)
-- Name: _contact; Type: TABLE; Schema: titan; Owner: postgres; Tablespace: 
--
...
ALTER TABLE titan._contact OWNER TO postgres;

--
-- TOC entry 184 (class 1259 OID 16464)
-- Name: _contact__id_seq; Type: SEQUENCE; Schema: titan; Owner: postgres
--
...
ALTER TABLE titan._contact__id_seq OWNER TO postgres;

--
-- TOC entry 2239 (class 0 OID 0)
-- Dependencies: 184
-- Name: _contact__id_seq; Type: SEQUENCE OWNED BY; Schema: titan; Owner: postgres
--
...
-- Dependencies: 184
-- Name: _contact__id_seq; Type: SEQUENCE SET; Schema: titan; Owner: postgres
--
...
-- Name: _disambiguation; Type: SEQUENCE; Schema: titan; Owner: postgres
--
...
ALTER TABLE titan._disambiguation OWNER TO postgres;

--
-- TOC entry 2241 (class 0 OID 0)
-- Dependencies: 191
-- Name: _disambiguation; Type: SEQUENCE SET; Schema: titan; Owner: postgres
--
...
-- Name: _file; Type: TABLE; Schema: titan; Owner: postgres; Tablespace: 
--
...
ALTER TABLE titan._file OWNER TO postgres;

--
-- TOC entry 175 (class 1259 OID 16411)
-- Name: _file__id_seq; Type: SEQUENCE; Schema: titan; Owner: postgres
--
...
ALTER TABLE titan._file__id_seq OWNER TO postgres;

--
-- TOC entry 2242 (class 0 OID 0)
-- Dependencies: 175
-- Name: _file__id_seq; Type: SEQUENCE OWNED BY; Schema: titan; Owner: postgres
--
...
-- Dependencies: 175
-- Name: _file__id_seq; Type: SEQUENCE SET; Schema: titan; Owner: postgres
--
...
-- Name: _group; Type: TABLE; Schema: titan; Owner: postgres; Tablespace: 
--
...
ALTER TABLE titan._group OWNER TO postgres;

--
-- TOC entry 173 (class 1259 OID 16403)
-- Name: _group__id_seq; Type: SEQUENCE; Schema: titan; Owner: postgres
--
...
ALTER TABLE titan._group__id_seq OWNER TO postgres;

--
-- TOC entry 2244 (class 0 OID 0)
-- Dependencies: 173
-- Name: _group__id_seq; Type: SEQUENCE OWNED BY; Schema: titan; Owner: postgres
--
...
-- Dependencies: 173
-- Name: _group__id_seq; Type: SEQUENCE SET; Schema: titan; Owner: postgres
--
...
-- Name: _instance; Type: TABLE; Schema: titan; Owner: postgres; Tablespace: 
--
...
ALTER TABLE titan._instance OWNER TO postgres;

--
-- TOC entry 187 (class 1259 OID 16482)
-- Name: _mail; Type: TABLE; Schema: titan; Owner: postgres; Tablespace: 
--
...
ALTER TABLE titan._mail OWNER TO postgres;

--
-- TOC entry 189 (class 1259 OID 16487)
-- Name: _media; Type: TABLE; Schema: titan; Owner: postgres; Tablespace: 
--
...
ALTER TABLE titan._media OWNER TO postgres;

--
-- TOC entry 188 (class 1259 OID 16485)
-- Name: _media__id_seq; Type: SEQUENCE; Schema: titan; Owner: postgres
--
...
ALTER TABLE titan._media__id_seq OWNER TO postgres;

--
-- TOC entry 2246 (class 0 OID 0)
-- Dependencies: 188
-- Name: _media__id_seq; Type: SEQUENCE OWNED BY; Schema: titan; Owner: postgres
--
...
-- Dependencies: 188
-- Name: _media__id_seq; Type: SEQUENCE SET; Schema: titan; Owner: postgres
--
...
-- Name: _permission; Type: TABLE; Schema: titan; Owner: postgres; Tablespace: 
--
...
ALTER TABLE titan._permission OWNER TO postgres;

--
-- TOC entry 183 (class 1259 OID 16453)
-- Name: _rss; Type: TABLE; Schema: titan; Owner: postgres; Tablespace: 
--
...
ALTER TABLE titan._rss OWNER TO postgres;

--
-- TOC entry 182 (class 1259 OID 16451)
-- Name: _rss__id_seq; Type: SEQUENCE; Schema: titan; Owner: postgres
--
...
ALTER TABLE titan._rss__id_seq OWNER TO postgres;

--
-- TOC entry 2248 (class 0 OID 0)
-- Dependencies: 182
-- Name: _rss__id_seq; Type: SEQUENCE OWNED BY; Schema: titan; Owner: postgres
--
...
-- Dependencies: 182
-- Name: _rss__id_seq; Type: SEQUENCE SET; Schema: titan; Owner: postgres
--
...
-- Name: _simple; Type: TABLE; Schema: titan; Owner: postgres; Tablespace: 
--
...
ALTER TABLE titan._simple OWNER TO postgres;

--
-- TOC entry 172 (class 1259 OID 16400)
-- Name: _state; Type: TABLE; Schema: titan; Owner: postgres; Tablespace: 
--
...
ALTER TABLE titan._state OWNER TO postgres;

--
-- TOC entry 178 (class 1259 OID 16427)
-- Name: _type_group; Type: TABLE; Schema: titan; Owner: postgres; Tablespace: 
--
...
ALTER TABLE titan._type_group OWNER TO postgres;

--
-- TOC entry 180 (class 1259 OID 16432)
-- Name: _user; Type: TABLE; Schema: titan; Owner: postgres; Tablespace: 
--
...
ALTER TABLE titan._user OWNER TO postgres;

--
-- TOC entry 179 (class 1259 OID 16430)
-- Name: _user__id_seq; Type: SEQUENCE; Schema: titan; Owner: postgres
--
...
ALTER TABLE titan._user__id_seq OWNER TO postgres;

--
-- TOC entry 2250 (class 0 OID 0)
-- Dependencies: 179
-- Name: _user__id_seq; Type: SEQUENCE OWNED BY; Schema: titan; Owner: postgres
--
...
-- Dependencies: 179
-- Name: _user__id_seq; Type: SEQUENCE SET; Schema: titan; Owner: postgres
--
...
-- Name: _user_group; Type: TABLE; Schema: titan; Owner: postgres; Tablespace: 
--
...
ALTER TABLE titan._user_group OWNER TO postgres;

SET search_path = siscad, pg_catalog;

--
-- TOC entry 2084 (class 2604 OID 24695)
-- Name: id; Type: DEFAULT; Schema: siscad; Owner: postgres
--
...
--
-- TOC entry 2081 (class 2604 OID 24674)
-- Name: id; Type: DEFAULT; Schema: siscad; Owner: postgres
--
...
--
-- TOC entry 2102 (class 2604 OID 24823)
-- Name: id; Type: DEFAULT; Schema: siscad; Owner: postgres
--

ALTER TABLE ONLY faltas ALTER COLUMN id SET DEFAULT nextval('faltas_id_seq'::regclass);


--
-- TOC entry 2095 (class 2604 OID 24773)
-- Name: id; Type: DEFAULT; Schema: siscad; Owner: postgres
--
...
--
-- TOC entry 2098 (class 2604 OID 24798)
-- Name: id; Type: DEFAULT; Schema: siscad; Owner: postgres
--
...
--
-- TOC entry 2088 (class 2604 OID 24738)
-- Name: id; Type: DEFAULT; Schema: siscad; Owner: postgres
--
...
--
-- TOC entry 2065 (class 2604 OID 16469)
-- Name: _id; Type: DEFAULT; Schema: titan; Owner: postgres
--
...
--
-- TOC entry 2045 (class 2604 OID 16416)
-- Name: _id; Type: DEFAULT; Schema: titan; Owner: postgres
--
...
--
-- TOC entry 2042 (class 2604 OID 16408)
-- Name: _id; Type: DEFAULT; Schema: titan; Owner: postgres
--
...
--
-- TOC entry 2069 (class 2604 OID 16490)
-- Name: _id; Type: DEFAULT; Schema: titan; Owner: postgres
--
...
--
-- TOC entry 2060 (class 2604 OID 16456)
-- Name: _id; Type: DEFAULT; Schema: titan; Owner: postgres
--
...
--
-- TOC entry 2208 (class 0 OID 24608)
-- Dependencies: 193
-- Data for Name: aluno; Type: TABLE DATA; Schema: siscad; Owner: postgres
--

COPY aluno (id, nome, datanascimento, nomepai, nomemae, endereco, sexo, cpf, email, idcurso, _user, _create, _update) FROM stdin;
3	Fabio da Silva Santos	1970-05-05 00:00:00	Jose maria	Joana dos Santos	Rua da paz	Masculino	96669330200	fabio@gmail.com	2	1	2014-11-02 00:33:16.028-03	2014-11-02 00:33:16.028-03
2	Robson Vanderlei SIlvestri	2014-11-02 00:00:00	Robson	SIlvestri	Rua Anhangüera	Feminino	96669330200	robsonok@gmail.com	1	1	2014-11-02 00:31:28.591-03	2014-11-02 00:33:33.812-03
4	João da Silva	1990-11-05 00:00:00	José	Maria	Rua da Paz	Masculino	96669330200	joao@gmail.com	3	1	2014-11-02 22:03:12.782-03	2014-11-02 22:03:12.782-03
5	Thiago Sousa	1993-11-10 00:00:00	Thiago Pai	Thiago Mae	Rua do nordeste	Masculino	96669330200	thiago@gmail.com	4	1	2014-11-02 22:05:09.113-03	2014-11-02 22:05:09.113-03
6	Rafaela Luna Leite	1990-10-28 00:00:00	Juscelino	Joana	Batayporã MS	Feminino	96669330200	rafa.luna@gmail.com	2	1	2014-11-03 22:39:37.224-03	2014-11-03 22:39:37.224-03
\.


--
-- TOC entry 2210 (class 0 OID 24692)
-- Dependencies: 199
-- Data for Name: curso; Type: TABLE DATA; Schema: siscad; Owner: postgres
--

COPY curso (id, nome, sigla, descricao, coordenador, duracao_min, duracao_max, carga_horaria_obrigatoria, carga_horaria_optativa, data_criacao_curso, _user, _create, _update, email_coordenador) FROM stdin;
2	Análise de Sistemas	AS	Curso de Análise de Sistemas	Irineu Sotoma	4	6	2700	300	2000-01-01 00:00:00	1	2014-11-02 21:44:16.732-03	2014-11-02 21:44:16.732-03	sotoma@facom.ufms.br
3	Ciência da Computação	CC	Curso de Ciência da Computação	Edna Ayako Hoshino	4	8	3281	300	1987-01-01 00:00:00	1	2014-11-02 21:48:14.901-03	2014-11-02 21:48:14.901-03	eah@facom.ufms.br
4	Engenharia da Computação	EC	Curso de Engenharia da Computação	Ricardo	5	8	4000	300	2011-01-01 00:00:00	1	2014-11-02 21:51:06.252-03	2014-11-02 21:51:06.252-03	ricardo@facom.ufms.br
5	Tecnologia em Análise e Desenvolvimento de Sistemas	TADS	Curso Tecnologia Analise e Desenvolvimento de Sistemas	Katia Mara França	3	6	2214	200	2010-01-01 00:00:00	1	2014-11-02 21:53:13.232-03	2014-11-02 21:53:53.916-03	katia@facom.ufms.br
6	Tecnologia em Redes de Computadores	TRC	Curso Tecnologia em Redes de Computadores	Renato Porfirio Ishii 	3	6	2195	200	2010-01-01 00:00:00	1	2014-11-02 21:55:25.941-03	2014-11-02 21:55:25.941-03	renato@facom.ufms.br
\.


--
-- TOC entry 2209 (class 0 OID 24671)
-- Dependencies: 197
-- Data for Name: disciplina; Type: TABLE DATA; Schema: siscad; Owner: postgres
--

COPY disciplina (id, nome, descricao, codigo, cargahoraria, tipo, _user, _create, _update) FROM stdin;
1	Algoritmo e Programação I	Algorirmos e Programação de Computadores 1	AlgProgI	132	optativa	1	2014-11-02 01:08:11.572-03	2014-11-02 01:08:31.493-03
2	Algoritmo e Programação II	Algorirmos e Programação de Computadores 2	AlgProgII	132	obrigatoria	1	2014-11-02 01:12:36.101-03	2014-11-02 01:12:36.101-03
\.


--
-- TOC entry 2214 (class 0 OID 24820)
-- Dependencies: 207
-- Data for Name: faltas; Type: TABLE DATA; Schema: siscad; Owner: postgres
--

COPY faltas (id, quantidade_faltas, data_falta, id_aluno, id_turma, _user, _create, _update) FROM stdin;
\.


--
-- TOC entry 2212 (class 0 OID 24770)
-- Dependencies: 203
-- Data for Name: matricula; Type: TABLE DATA; Schema: siscad; Owner: postgres
--

COPY matricula (id, data_matricula, ano, semestre, id_turma, id_aluno, _user, _create, _update) FROM stdin;
1	2014-11-03 00:00:00	2014	2Semestre	1	3	1	2014-11-03 00:23:06.506-03	2014-11-03 00:23:06.506-03
2	2014-11-03 00:00:00	2014	1Semestre	1	2	1	2014-11-03 21:15:43.215-03	2014-11-03 21:15:43.215-03
3	2014-11-03 00:00:00	2014	1Semestre	1	6	1	2014-11-03 22:40:13.55-03	2014-11-03 22:40:13.55-03
4	2014-11-03 00:00:00	2014	1Semestre	1	5	1	2014-11-03 22:40:33.943-03	2014-11-03 22:40:33.943-03
\.


--
-- TOC entry 2213 (class 0 OID 24795)
-- Dependencies: 205
-- Data for Name: nota; Type: TABLE DATA; Schema: siscad; Owner: postgres
--

COPY nota (id, valor_real, valor_equivalente, id_aluno, id_turma, _user, _create, _update) FROM stdin;
\.


--
-- TOC entry 2207 (class 0 OID 24584)
-- Dependencies: 192
-- Data for Name: professor; Type: TABLE DATA; Schema: siscad; Owner: postgres
--

COPY professor (id, nome, datanascimento, escolaridade, endereco, email, cpf, sexo, _insert, _update, _user) FROM stdin;
4	Robson Vanderlei SIlvestri	2014-11-02 00:00:00	Superior Completo	Rua Anhangüera	robsonok@gmail.com	96669330200	Masculino	2014-11-02 00:29:33.789-03	2014-11-02 00:29:33.789-03	1
5	Paulo Tiene	1993-10-15 00:00:00	Doutor	Rua Anhangüera, 1834	dutiene@gmail.com	40034236821	Masculino	2014-11-03 21:13:49.624-03	2014-11-03 21:13:49.624-03	1
\.


--
-- TOC entry 2211 (class 0 OID 24735)
-- Dependencies: 201
-- Data for Name: turma; Type: TABLE DATA; Schema: siscad; Owner: postgres
--

COPY turma (id, codigo, data_inicio, data_fim, semestre, ano, turno, local, horario_aula, dias_semana, id_disciplina, id_professor, _user, _create, _update, quantidade_prova, quantidade_trabalho, valor_prova, valor_trabalho, ps) FROM stdin;
3	AlgProgII Turma02	2014-06-03 00:00:00	2014-11-03 00:00:00	2Semestre	2014	Matutino	Multiuso - Térreo - sala047	07 as 8:40	Segunda-feira, Quarta-feira e Sexta-Feira	2	5	1	2014-11-03 22:32:02.91-03	2014-11-03 22:32:02.91-03	3	2	75	25	1
1	AlgProg Turma01	2014-01-01 00:00:00	2014-06-30 00:00:00	1Semestre	2014	Noturno	Multiuso - Térreo - sala03 	19 as 22:40	2º, 4º, 6º	1	4	1	2014-11-02 23:11:39.824-03	2014-11-03 22:32:50.765-03	2	0	100	0	0
\.
...
--
-- TOC entry 2193 (class 0 OID 16397)
-- Dependencies: 171
-- Data for Name: _city; Type: TABLE DATA; Schema: titan; Owner: postgres
--
...
-- Dependencies: 185
-- Data for Name: _contact; Type: TABLE DATA; Schema: titan; Owner: postgres
--
...
--
-- TOC entry 2196 (class 0 OID 16413)
-- Dependencies: 176
-- Data for Name: _file; Type: TABLE DATA; Schema: titan; Owner: postgres
--
...
--
-- TOC entry 2195 (class 0 OID 16405)
-- Dependencies: 174
-- Data for Name: _group; Type: TABLE DATA; Schema: titan; Owner: postgres
--
...
--
-- TOC entry 2206 (class 0 OID 16497)
-- Dependencies: 190
-- Data for Name: _instance; Type: TABLE DATA; Schema: titan; Owner: postgres
--
...
--
-- TOC entry 2204 (class 0 OID 16482)
-- Dependencies: 187
-- Data for Name: _mail; Type: TABLE DATA; Schema: titan; Owner: postgres
--
...
--
-- TOC entry 2205 (class 0 OID 16487)
-- Dependencies: 189
-- Data for Name: _media; Type: TABLE DATA; Schema: titan; Owner: postgres
--
...
--
-- TOC entry 2197 (class 0 OID 16424)
-- Dependencies: 177
-- Data for Name: _permission; Type: TABLE DATA; Schema: titan; Owner: postgres
--

COPY _permission (_name, _group) FROM stdin;
ACCESS_SECTION_home	1
ACCESS_ACTION_home_home	1
...
ACCESS_SECTION_manager	1
ACCESS_ACTION_manager_list	1
ACCESS_ACTION_manager_create	1
ACCESS_ACTION_manager_edit	1
ACCESS_ACTION_manager_delete	1
ACCESS_ACTION_manager_view	1
ACCESS_ACTION_manager_graph	1
ACCESS_SECTION_professores	1
ACCESS_ACTION_professores_list	1
ACCESS_ACTION_professores_view	1
ACCESS_ACTION_professores_create	1
ACCESS_ACTION_professores_edit	1
ACCESS_ACTION_professores_delete	1
ACCESS_SECTION_alunos	1
ACCESS_ACTION_alunos_list	1
ACCESS_ACTION_alunos_view	1
ACCESS_ACTION_alunos_create	1
ACCESS_ACTION_alunos_edit	1
ACCESS_ACTION_alunos_delete	1
ACCESS_SECTION_disciplinas	1
ACCESS_ACTION_disciplinas_list	1
ACCESS_ACTION_disciplinas_view	1
ACCESS_ACTION_disciplinas_create	1
ACCESS_ACTION_disciplinas_edit	1
ACCESS_ACTION_disciplinas_delete	1
ACCESS_SECTION_cursos	1
ACCESS_ACTION_cursos_list	1
ACCESS_ACTION_cursos_view	1
ACCESS_ACTION_cursos_create	1
ACCESS_ACTION_cursos_edit	1
ACCESS_ACTION_cursos_delete	1
ACCESS_SECTION_turmas	1
ACCESS_ACTION_turmas_list	1
ACCESS_ACTION_turmas_view	1
ACCESS_ACTION_turmas_create	1
ACCESS_ACTION_turmas_edit	1
ACCESS_ACTION_turmas_delete	1
ACCESS_SECTION_matriculas	1
ACCESS_ACTION_matriculas_list	1
ACCESS_ACTION_matriculas_view	1
ACCESS_ACTION_matriculas_create	1
ACCESS_ACTION_matriculas_edit	1
ACCESS_ACTION_matriculas_delete	1
ACCESS_SECTION_notas	1
ACCESS_ACTION_notas_list	1
ACCESS_ACTION_notas_view	1
ACCESS_ACTION_notas_create	1
ACCESS_ACTION_notas_edit	1
ACCESS_ACTION_notas_delete	1
ACCESS_SECTION_faltas	1
ACCESS_ACTION_faltas_list	1
ACCESS_ACTION_faltas_view	1
ACCESS_ACTION_faltas_edit	1
ACCESS_ACTION_faltas_delete	1
PERMISSION_faltas__VIEW_ALL_	1
\.


--
-- TOC entry 2201 (class 0 OID 16453)
-- Dependencies: 183
-- Data for Name: _rss; Type: TABLE DATA; Schema: titan; Owner: postgres
--
...
--
-- TOC entry 2203 (class 0 OID 16475)
-- Dependencies: 186
-- Data for Name: _simple; Type: TABLE DATA; Schema: titan; Owner: postgres
--
...
--
-- TOC entry 2194 (class 0 OID 16400)
-- Dependencies: 172
-- Data for Name: _state; Type: TABLE DATA; Schema: titan; Owner: postgres
--
...
--
-- TOC entry 2198 (class 0 OID 16427)
-- Dependencies: 178
-- Data for Name: _type_group; Type: TABLE DATA; Schema: titan; Owner: postgres
--
...
--
-- TOC entry 2199 (class 0 OID 16432)
-- Dependencies: 180
-- Data for Name: _user; Type: TABLE DATA; Schema: titan; Owner: postgres
--
...
1	Administrador	admin	d033e22ae348aeb5660fc2140aec35850c4da997	1		0	manager	pt_BR	2014-10-31 20:01:13.495-03	2014-10-31 20:01:13.495-03	2014-11-04 22:45:18.43-03	1	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	_M_	_OTHER_
\.


--
-- TOC entry 2200 (class 0 OID 16448)
-- Dependencies: 181
-- Data for Name: _user_group; Type: TABLE DATA; Schema: titan; Owner: postgres
--
...
--
-- TOC entry 2141 (class 2606 OID 24638)
-- Name: Professor_pkey; Type: CONSTRAINT; Schema: siscad; Owner: postgres; Tablespace: 
--
...
--
-- TOC entry 2149 (class 2606 OID 24701)
-- Name: curso_nome_key; Type: CONSTRAINT; Schema: siscad; Owner: postgres; Tablespace: 
--
...
--
-- TOC entry 2151 (class 2606 OID 24699)
-- Name: curso_pkey; Type: CONSTRAINT; Schema: siscad; Owner: postgres; Tablespace: 
--
...
--
-- TOC entry 2153 (class 2606 OID 24703)
-- Name: curso_sigla_key; Type: CONSTRAINT; Schema: siscad; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY curso
    ADD CONSTRAINT curso_sigla_key UNIQUE (sigla);


--
-- TOC entry 2147 (class 2606 OID 24754)
-- Name: disciplina_pkey; Type: CONSTRAINT; Schema: siscad; Owner: postgres; Tablespace: 
--
...
--
-- TOC entry 2161 (class 2606 OID 24827)
-- Name: faltas_pkey; Type: CONSTRAINT; Schema: siscad; Owner: postgres; Tablespace: 
--
...
--
-- TOC entry 2157 (class 2606 OID 24777)
-- Name: matricula_pkey; Type: CONSTRAINT; Schema: siscad; Owner: postgres; Tablespace: 
--
...
--
-- TOC entry 2159 (class 2606 OID 24802)
-- Name: nota_pkey; Type: CONSTRAINT; Schema: siscad; Owner: postgres; Tablespace: 
--
...
--
-- TOC entry 2143 (class 2606 OID 24641)
-- Name: professor_cpf_key; Type: CONSTRAINT; Schema: siscad; Owner: postgres; Tablespace: 
--
...
--
-- TOC entry 2145 (class 2606 OID 24633)
-- Name: table1_pkey; Type: CONSTRAINT; Schema: siscad; Owner: postgres; Tablespace: 
--
...
--
-- TOC entry 2155 (class 2606 OID 24742)
-- Name: turma_pkey; Type: CONSTRAINT; Schema: siscad; Owner: postgres; Tablespace: 
--
...
-- Name: _city_pkey; Type: CONSTRAINT; Schema: titan; Owner: postgres; Tablespace: 
--
...
--
-- TOC entry 2131 (class 2606 OID 16627)
-- Name: _contact_pkey; Type: CONSTRAINT; Schema: titan; Owner: postgres; Tablespace: 
--
...
--
-- TOC entry 2111 (class 2606 OID 16560)
-- Name: _file_pkey; Type: CONSTRAINT; Schema: titan; Owner: postgres; Tablespace: 
--
...
--
-- TOC entry 2109 (class 2606 OID 16562)
-- Name: _group_pkey; Type: CONSTRAINT; Schema: titan; Owner: postgres; Tablespace: 
--
...
--
-- TOC entry 2115 (class 2606 OID 16569)
-- Name: _group_type_idx; Type: CONSTRAINT; Schema: titan; Owner: postgres; Tablespace: 
--
...
--
-- TOC entry 2139 (class 2606 OID 16655)
-- Name: _instance_pkey; Type: CONSTRAINT; Schema: titan; Owner: postgres; Tablespace: 
--
...
--
-- TOC entry 2135 (class 2606 OID 16646)
-- Name: _mail_idx; Type: CONSTRAINT; Schema: titan; Owner: postgres; Tablespace: 
--
...
--
-- TOC entry 2137 (class 2606 OID 16648)
-- Name: _media_pkey; Type: CONSTRAINT; Schema: titan; Owner: postgres; Tablespace: 
--
...
--
-- TOC entry 2113 (class 2606 OID 16576)
-- Name: _permission_idx; Type: CONSTRAINT; Schema: titan; Owner: postgres; Tablespace: 
--
...
--
-- TOC entry 2133 (class 2606 OID 16634)
-- Name: _simple_pkey; Type: CONSTRAINT; Schema: titan; Owner: postgres; Tablespace: 
--
...
--
-- TOC entry 2107 (class 2606 OID 16553)
-- Name: _state_pkey; Type: CONSTRAINT; Schema: titan; Owner: postgres; Tablespace: 
--
...
--
-- TOC entry 2117 (class 2606 OID 16601)
-- Name: _user__email_key; Type: CONSTRAINT; Schema: titan; Owner: postgres; Tablespace: 
--
...
--
-- TOC entry 2119 (class 2606 OID 16605)
-- Name: _user__facebook_key; Type: CONSTRAINT; Schema: titan; Owner: postgres; Tablespace: 
--
...
-- Name: _user__google_key; Type: CONSTRAINT; Schema: titan; Owner: postgres; Tablespace: 
--
...
--
-- TOC entry 2123 (class 2606 OID 16599)
-- Name: _user__login_key; Type: CONSTRAINT; Schema: titan; Owner: postgres; Tablespace: 
--
...
-- Name: _user_group_idx; Type: CONSTRAINT; Schema: titan; Owner: postgres; Tablespace: 
--
...
-- Name: _user_pkey; Type: CONSTRAINT; Schema: titan; Owner: postgres; Tablespace: 
--
...
--
-- TOC entry 2129 (class 2606 OID 16592)
-- Name: rss_pkey; Type: CONSTRAINT; Schema: titan; Owner: postgres; Tablespace: 
--
...
--
-- TOC entry 2178 (class 2606 OID 24591)
-- Name: author_user_fk; Type: FK CONSTRAINT; Schema: siscad; Owner: postgres
--

ALTER TABLE ONLY professor
    ADD CONSTRAINT author_user_fk FOREIGN KEY (_user) REFERENCES titan._user(_id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- TOC entry 2179 (class 2606 OID 24625)
-- Name: author_user_fk; Type: FK CONSTRAINT; Schema: siscad; Owner: postgres
--
...
--
-- TOC entry 2180 (class 2606 OID 24704)
-- Name: curso_user_fk; Type: FK CONSTRAINT; Schema: siscad; Owner: postgres
--

ALTER TABLE ONLY curso
    ADD CONSTRAINT curso_user_fk FOREIGN KEY (_user) REFERENCES titan._user(_id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- TOC entry 2183 (class 2606 OID 24755)
-- Name: disciplina_turma_fk; Type: FK CONSTRAINT; Schema: siscad; Owner: postgres
--

ALTER TABLE ONLY turma
    ADD CONSTRAINT disciplina_turma_fk FOREIGN KEY (id_disciplina) REFERENCES disciplina(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- TOC entry 2192 (class 2606 OID 24838)
-- Name: faltas_aluno_fk; Type: FK CONSTRAINT; Schema: siscad; Owner: postgres
--

ALTER TABLE ONLY faltas
    ADD CONSTRAINT faltas_aluno_fk FOREIGN KEY (id_turma) REFERENCES turma(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- TOC entry 2191 (class 2606 OID 24833)
-- Name: faltas_turma_fk; Type: FK CONSTRAINT; Schema: siscad; Owner: postgres
--

ALTER TABLE ONLY faltas
    ADD CONSTRAINT faltas_turma_fk FOREIGN KEY (id_aluno) REFERENCES aluno(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- TOC entry 2190 (class 2606 OID 24828)
-- Name: faltas_user_fk; Type: FK CONSTRAINT; Schema: siscad; Owner: postgres
--

ALTER TABLE ONLY faltas
    ADD CONSTRAINT faltas_user_fk FOREIGN KEY (_user) REFERENCES titan._user(_id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- TOC entry 2186 (class 2606 OID 24788)
-- Name: matricula_aluno_fk; Type: FK CONSTRAINT; Schema: siscad; Owner: postgres
--

ALTER TABLE ONLY matricula
    ADD CONSTRAINT matricula_aluno_fk FOREIGN KEY (id_turma) REFERENCES turma(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- TOC entry 2189 (class 2606 OID 24813)
-- Name: matricula_aluno_fk; Type: FK CONSTRAINT; Schema: siscad; Owner: postgres
--
...
--
-- TOC entry 2184 (class 2606 OID 24778)
-- Name: matricula_user_fk; Type: FK CONSTRAINT; Schema: siscad; Owner: postgres
--

ALTER TABLE ONLY matricula
    ADD CONSTRAINT matricula_user_fk FOREIGN KEY (_user) REFERENCES titan._user(_id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- TOC entry 2187 (class 2606 OID 24803)
-- Name: nota_user_fk; Type: FK CONSTRAINT; Schema: siscad; Owner: postgres
--

ALTER TABLE ONLY nota
    ADD CONSTRAINT nota_user_fk FOREIGN KEY (_user) REFERENCES titan._user(_id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- TOC entry 2182 (class 2606 OID 24748)
-- Name: professor_turma_fk; Type: FK CONSTRAINT; Schema: siscad; Owner: postgres
--

ALTER TABLE ONLY turma
    ADD CONSTRAINT professor_turma_fk FOREIGN KEY (id_professor) REFERENCES professor(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- TOC entry 2185 (class 2606 OID 24783)
-- Name: professor_turma_fk; Type: FK CONSTRAINT; Schema: siscad; Owner: postgres
--

ALTER TABLE ONLY matricula
    ADD CONSTRAINT professor_turma_fk FOREIGN KEY (id_aluno) REFERENCES aluno(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- TOC entry 2188 (class 2606 OID 24808)
-- Name: professor_turma_fk; Type: FK CONSTRAINT; Schema: siscad; Owner: postgres
--
...
--
-- TOC entry 2181 (class 2606 OID 24743)
-- Name: turma_user_fk; Type: FK CONSTRAINT; Schema: siscad; Owner: postgres
--

ALTER TABLE ONLY turma
    ADD CONSTRAINT turma_user_fk FOREIGN KEY (_user) REFERENCES titan._user(_id) ON UPDATE CASCADE ON DELETE CASCADE;


SET search_path = titan, pg_catalog;

--
-- TOC entry 2162 (class 2606 OID 16554)
-- Name: _city_state_fk; Type: FK CONSTRAINT; Schema: titan; Owner: postgres
--
...
--
-- TOC entry 2172 (class 2606 OID 16628)
-- Name: _contact_responser_fk; Type: FK CONSTRAINT; Schema: titan; Owner: postgres
--
...
--
-- TOC entry 2163 (class 2606 OID 16606)
-- Name: _file_user_fk; Type: FK CONSTRAINT; Schema: titan; Owner: postgres
--
...
--
-- TOC entry 2165 (class 2606 OID 16563)
-- Name: _group_type_group_fk; Type: FK CONSTRAINT; Schema: titan; Owner: postgres
--
...
--
-- TOC entry 2176 (class 2606 OID 16656)
-- Name: _instance_logo_fk; Type: FK CONSTRAINT; Schema: titan; Owner: postgres
--
...
--
-- TOC entry 2177 (class 2606 OID 16661)
-- Name: _instance_user_fk; Type: FK CONSTRAINT; Schema: titan; Owner: postgres
--
...
--
-- TOC entry 2174 (class 2606 OID 16640)
-- Name: _mail_group_fk; Type: FK CONSTRAINT; Schema: titan; Owner: postgres
--
...
--
-- TOC entry 2175 (class 2606 OID 16649)
-- Name: _media_user_fk; Type: FK CONSTRAINT; Schema: titan; Owner: postgres
--
...
-- Name: _permission_group_fk; Type: FK CONSTRAINT; Schema: titan; Owner: postgres
--
...
--
-- TOC entry 2173 (class 2606 OID 16635)
-- Name: _simple_user_fk; Type: FK CONSTRAINT; Schema: titan; Owner: postgres
--
...
--
-- TOC entry 2166 (class 2606 OID 16611)
-- Name: _user_city_fk; Type: FK CONSTRAINT; Schema: titan; Owner: postgres
--
...
--
-- TOC entry 2167 (class 2606 OID 16616)
-- Name: _user_file_fk; Type: FK CONSTRAINT; Schema: titan; Owner: postgres
--
...
--
-- TOC entry 2169 (class 2606 OID 16579)
-- Name: _user_group_group_fk; Type: FK CONSTRAINT; Schema: titan; Owner: postgres
--
...
--
-- TOC entry 2170 (class 2606 OID 16584)
-- Name: _user_group_user_fk; Type: FK CONSTRAINT; Schema: titan; Owner: postgres
--
...
--
-- TOC entry 2168 (class 2606 OID 16621)
-- Name: _user_state_fk; Type: FK CONSTRAINT; Schema: titan; Owner: postgres
--
...
--
-- TOC entry 2171 (class 2606 OID 16593)
-- Name: rss_user_fk; Type: FK CONSTRAINT; Schema: titan; Owner: postgres
--
...
-- Completed on 2014-11-05 17:35:42
